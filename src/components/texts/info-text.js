...
const DEFAULT_INFO_TEXT_STYLE = DefaultTheme.text.font.info;
...
const readjustStyle = (newStyle = {
    ...
    indentation: 0,
    color: `themed`
}, prevAdjustedStyle = DEFAULT_INFO_TEXT_STYLE, Theme = DefaultTheme) => {
    const {
        shade,
        alignment,
        decoration,
    ...
    const themedShade = shade === `themed` ? Theme.text.info.shade : shade;
    let themedColor;

    if (color === `themed`) {
        if (Theme.text.color.info.hasOwnProperty(Theme.text.info.color)) {
            themedColor = Theme.text.color.info[Theme.text.info.color][themedShade];
        } else {
            themedColor = Theme.text.info.color;
        }
    } else if (Theme.text.color.info.hasOwnProperty(color)) {
        themedColor = Theme.text.color.info[color][themedShade];
    } else {
        themedColor = color;
    }
    ...
    return {
        small: {
            ...
            ...Theme.text.font.info.small,
            fontFamily: font === `themed` ? Theme.text.font.info.small.fontFamily : font,
            textAlign: alignment,
        ...
        normal: {
            ...
            ...Theme.text.font.info.normal,
            fontFamily: font === `themed` ? Theme.text.font.info.normal.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
        ...
        large: {
            ...
            ...Theme.text.font.info.large,
            fontFamily: font === `themed` ? Theme.text.font.info.large.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
...
export default class InfoText extends React.Component {
    ...
    constructor (props) {
        ...
        component.state = {
            ...
            adjustedStyle: DEFAULT_INFO_TEXT_STYLE
        };
    }
    animate (animation = {
        ...
        if (typeof animation === `string` && animation !== `none`) {
            ...
            if (Theme.text.animation.info.hasOwnProperty(animationName)) {
                animation = Theme.text.animation.info[animationName];
            }
        }
    ...
    render () {
        ...
        const themedSize = size === `themed` ? Theme.text.info.size : size;
