...
const DEFAULT_HEADLINE_TEXT_STYLE = DefaultTheme.text.font.headline;
...
const readjustStyle = (newStyle = {
    ...
    indentation: 0,
    color: `themed`
}, prevAdjustedStyle = DEFAULT_HEADLINE_TEXT_STYLE, Theme = DefaultTheme) => {
    const {
        shade,
        alignment,
        decoration,
    ...
    const themedShade = shade === `themed` ? Theme.text.headline.shade : shade;
    let themedColor;

    if (color === `themed`) {
        if (Theme.text.color.headline.hasOwnProperty(Theme.text.headline.color)) {
            themedColor = Theme.text.color.headline[Theme.text.headline.color][themedShade];
        } else {
            themedColor = Theme.text.headline.color;
        }
    } else if (Theme.text.color.headline.hasOwnProperty(color)) {
        themedColor = Theme.text.color.headline[color][themedShade];
    } else {
        themedColor = color;
    }
    ...
    return {
        small: {
            ...
            ...Theme.text.font.headline.small,
            fontFamily: font === `themed` ? Theme.text.font.headline.small.fontFamily : font,
            textAlign: alignment,
        ...
        normal: {
            ...
            ...Theme.text.font.headline.normal,
            fontFamily: font === `themed` ? Theme.text.font.headline.normal.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
        ...
        large: {
            ...
            ...Theme.text.font.headline.large,
            fontFamily: font === `themed` ? Theme.text.font.headline.large.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
...
export default class HeadLineText extends React.Component {
    ...
    constructor (props) {
        ...
        component.state = {
            ...
            adjustedStyle: DEFAULT_HEADLINE_TEXT_STYLE
        };
    }
    animate (animation = {
        ...
        if (typeof animation === `string` && animation !== `none`) {
            ...
            if (Theme.text.animation.headline.hasOwnProperty(animationName)) {
                animation = Theme.text.animation.headline[animationName];
            }
        }
    ...
    render () {
        ...
        const themedSize = size === `themed` ? Theme.text.headline.size : size;
