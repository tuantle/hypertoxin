...
const DEFAULT_CAPTION_TEXT_STYLE = DefaultTheme.text.font.caption;
...
const readjustStyle = (newStyle = {
    ...
    indentation: 0,
    color: `themed`
}, prevAdjustedStyle = DEFAULT_CAPTION_TEXT_STYLE, Theme = DefaultTheme) => {
    const {
        shade,
        alignment,
        decoration,
    ...
    const themedShade = shade === `themed` ? Theme.text.caption.shade : shade;
    let themedColor;

    if (color === `themed`) {
        if (Theme.text.color.caption.hasOwnProperty(Theme.text.caption.color)) {
            themedColor = Theme.text.color.caption[Theme.text.caption.color][themedShade];
        } else {
            themedColor = Theme.text.caption.color;
        }
    } else if (Theme.text.color.caption.hasOwnProperty(color)) {
        themedColor = Theme.text.color.caption[color][themedShade];
    } else {
        themedColor = color;
    }
    ...
    return {
        small: {
            ...
            ...Theme.text.font.caption.small,
            fontFamily: font === `themed` ? Theme.text.font.caption.small.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
            color: themedColor,
            ...(typeof style === `object` && style.hasOwnProperty(`small`) && typeof style.small === `object` ? style.small : {})
        },
        normal: {
            ...prevAdjustedStyle.normal,
            ...Theme.text.font.caption.normal,
            fontFamily: font === `themed` ? Theme.text.font.caption.normal.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
            color: themedColor,
            ...(typeof style === `object` && style.hasOwnProperty(`normal`) && typeof style.normal === `object` ? style.normal : {})
        },
        large: {
            ...prevAdjustedStyle.large,
            ...Theme.text.font.caption.large,
            fontFamily: font === `themed` ? Theme.text.font.caption.large.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
            color: themedColor,
            ...(typeof style === `object` && style.hasOwnProperty(`large`) && typeof style.large === `object` ? style.large : {})
        }
    };
};
...
export default class CaptionText extends React.Component {
    ...
    constructor (props) {
        ...
        component.state = {
            ...
            adjustedStyle: DEFAULT_CAPTION_TEXT_STYLE
        };
    }
    animate (animation = {
        ...
        if (typeof animation === `string` && animation !== `none`) {
            ...
            if (Theme.text.animation.caption.hasOwnProperty(animationName)) {
                animation = Theme.text.animation.caption[animationName];
            }
        }
    ...
    render () {
        ...
        const themedSize = size === `themed` ? Theme.text.caption.size : size;
