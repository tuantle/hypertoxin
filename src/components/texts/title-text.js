...
const DEFAULT_TITLE_TEXT_STYLE = DefaultTheme.text.font.title;
...
const readjustStyle = (newStyle = {
    ...
    indentation: 0,
    color: `themed`
}, prevAdjustedStyle = DEFAULT_TITLE_TEXT_STYLE, Theme = DefaultTheme) => {
    const {
        shade,
        alignment,
        decoration,
    ...
    const themedShade = shade === `themed` ? Theme.text.title.shade : shade;
    let themedColor;

    if (color === `themed`) {
        if (Theme.text.color.title.hasOwnProperty(Theme.text.title.color)) {
            themedColor = Theme.text.color.title[Theme.text.title.color][themedShade];
        } else {
            themedColor = Theme.text.title.color;
        }
    } else if (Theme.text.color.title.hasOwnProperty(color)) {
        themedColor = Theme.text.color.title[color][themedShade];
    } else {
        themedColor = color;
    }
    ...
    return {
        small: {
            ...
            ...Theme.text.font.title.small,
            fontFamily: font === `themed` ? Theme.text.font.title.small.fontFamily : font,
            textAlign: alignment,
        ...
        normal: {
            ...
            ...Theme.text.font.title.normal,
            fontFamily: font === `themed` ? Theme.text.font.title.normal.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
        ...
        large: {
            ...
            ...Theme.text.font.title.large,
            fontFamily: font === `themed` ? Theme.text.font.title.large.fontFamily : font,
            textAlign: alignment,
            textDecorationLine: decoration,
            paddingLeft: indentation > 0 ? indentation : 0,
            paddingRight: indentation < 0 ? -indentation : 0,
...
export default class TitleText extends React.Component {
    ...
    constructor (props) {
        ...
        component.state = {
            ...
            adjustedStyle: DEFAULT_TITLE_TEXT_STYLE
        };
    }
    animate (animation = {
        ...
        if (typeof animation === `string` && animation !== `none`) {
            ...
            if (Theme.text.animation.title.hasOwnProperty(animationName)) {
                animation = Theme.text.animation.title[animationName];
            }
        }
    ...
    render () {
        ...
        const themedSize = size === `themed` ? Theme.text.title.size : size;
