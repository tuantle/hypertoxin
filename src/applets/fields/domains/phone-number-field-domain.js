 ...
 *------------------------------------------------------------------------
 *
 * @module PhoneNumberFieldDomain
 * @description - Phone number field applet domain.
 *
...
import PhoneNumberFieldStore from '../stores/field-store';

import PhoneNumberFieldInterface from '../interfaces/phone-number-field-interface';

import EVENT from '../events/field-event';

const PhoneNumberFieldDomain = Hf.Domain.augment({
    $init: function $init () {
        const domain = this;
        domain.register({
            store: PhoneNumberFieldStore({
                name: `phone-number-field-store`
            }),
            intf: PhoneNumberFieldInterface({
                name: domain.name
            })
        });
    },
...
export default PhoneNumberFieldDomain;
