...
const readjustStyle = (newStyle = {
    ...
    if (typeof padding === `string`) {
        if (padding === `themed`) {
            if (typeof Theme.layout.column.padding === `string` && Theme.layout.padding.column.hasOwnProperty(Theme.layout.column.padding)) {
                themedPadding = Theme.layout.padding.column[Theme.layout.column.padding];
            } else {
                themedPadding = Theme.layout.column.padding;
            }
        } else if (Theme.layout.padding.column.hasOwnProperty(padding)) {
            themedPadding = Theme.layout.padding.column[padding];
        } else {
            themedPadding = 0;
        }
    } else {
