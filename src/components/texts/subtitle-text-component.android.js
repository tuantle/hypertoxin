 ...
 * @description - Subtitle text android component.
 *
...
const SubtitleTextInterface = Hf.Interface.augment({
    ...
    state: {
        ...
        shade: {
            value: Ht.Theme.text.subtitle.shade,
            oneOf: [ `light`, `dark` ],
            stronglyTyped: true
        },
        color: {
            value: Ht.Theme.text.subtitle.color,
            stronglyTyped: true
        },
        size: {
            value: Ht.Theme.text.subtitle.size,
            oneOf: [ `small`, `normal`, `large` ],
            stronglyTyped: true
        },
        alignment: {
            value: Ht.Theme.text.subtitle.alignment,
            oneOf: [ `left`, `center`, `right` ],
            stronglyTyped: true
        },
        decoration: {
            value: Ht.Theme.text.subtitle.decoration,
